$(document).ready(function(){
	...
	document.getElementById('stats-sentence').innerHTML = "<h3>There were</h3><h2>" + sample + "</h2><h3>recipes sampled from the</h3><h2>" + course + "</h2><h3>category. The flavor averages were:</h3>"
